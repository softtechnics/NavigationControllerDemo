//
//  NavigationControllerDemoAppDelegate.m
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	UIViewController* viewCtrl = [[TestViewController1 alloc] initWithNibName:nil bundle:nil];
	
    [self.navigationController setViewControllers:[NSArray arrayWithObject:viewCtrl]];
	[viewCtrl release];
